...
import com.myclaero.claeroauto.SNACK_ERROR
...
class ProfileActivity : AppCompatActivity() {
	...
	private fun submit(v: View) {
		...
		ParseUser.getCurrentUser().apply {
			put("nameFirst", editNameFirst.getString())
			put("nameLast", editNameLast.getString())
			...
			if (e == null) {
				...
				MainActivity().makeSnack(this@ProfileActivity, layoutProfile, R.string.parse_error, SNACK_ERROR)
